About myst-parser-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/myst-parser-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9227&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/myst-parser-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `myst-parser` can be installed with `conda`:
...
It is possible to list all of the versions of `myst-parser` available on your platform with `conda`:
...
```
mamba search myst-parser --channel conda-forge
```
...
mamba repoquery search myst-parser --channel conda-forge

# List packages depending on `myst-parser`:
mamba repoquery whoneeds myst-parser --channel conda-forge

# List dependencies of `myst-parser`:
mamba repoquery depends myst-parser --channel conda-forge
```
